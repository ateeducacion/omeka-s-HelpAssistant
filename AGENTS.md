...
Supported PHP: `^8.0` (`composer.json`); check `config/module.ini` for Omeka compatibility.
...
Read [admin-help-tours](.agents/skills/admin-help-tours/SKILL.md) when you need to: change contextual admin tours, tour mappings, redirects, or Intro.js integration.
